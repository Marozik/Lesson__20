(() => {
    ...
    function initSliders() {
        if (document.querySelector(".our-team__slider")) new core(".our-team__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 800,
            navigation: {
                prevEl: ".navigation-buttons__arrow--prev",
                nextEl: ".navigation-buttons__arrow--next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".testimonials__slider")) new core(".testimonials__slider", {
            ...
            navigation: {
                prevEl: ".navigation-buttons__arrow--prev-testimonials",
                nextEl: ".navigation-buttons__arrow--next-testimonials"
            },
            on: {}
        });
    }
